...
class Controller {
  async create(req, res, next) {
    try {
      ...
      if (validateEmail) {
        ...
        let new1 = {};
        new1["accessToken"] = accessToken;
        new1.existingUser = true;
        new1.apiMsg = "Account Created";
        Object.assign(new1, socialUser.toJSON());
        console.log("got2 !!", new1);
      ...
      if (payload.socialType == "normal") {
        ...
        if (user) {
          user.comparePassword(req.body.password, (err, isMatch) => {
            ...
            newUser["apiMsg"] = "Normal Login";
            newUser["existingUser"] = true;
            Object.assign(newUser, user.toJSON());
            console.log("got4!!", newUser);
        ...
        if (!user) {
          ...
          let newUser = {};
          newUser["accessToken"] = accessToken;
          newUser["apiMsg"] = "login social id success";
          newUser["existingUser"] = true;
          Object.assign(newUser, user.toJSON());
          console.log("got4!!", newUser);
          // let newUser = {
  ...
  //     let user = await commonFunctions.validateEmail(decoded);
  //     console.log("Validated email by searching in DB = ", user);
  ...
  //     });
  //   } else {
  //     res.send({ code: 400, message: ERROR_MESSAGE.INVALID_AUTH });
  //   }
  // }
  ...
  async logOut(req, res) {
    ...
    console.log(
      "your body for logout is==================================",
      req.body
    );
    if (req.session) {
      console.log("sesion of user is", req.session);
